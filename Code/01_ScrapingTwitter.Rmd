...
```{r}
# Loading Round 1
bs_to_df1 <- readRDS('bs_to_df1.rds')
ew_to_df1 <- readRDS('ew_to_df1.rds')
cb_to_df1 <- readRDS('cb_to_df1.rds')
kh_to_df1 <- readRDS('kh_to_df1.rds')
cs_to_df1 <- readRDS('cs_to_df1.rds')
kg_to_df1 <- readRDS('kg_to_df1.rds')

# Loading Round 2
bs_to_df2 <- readRDS('bs_to_df2.rds')
ew_to_df2 <- readRDS('ew_to_df2.rds')
cb_to_df2 <- readRDS('cb_to_df2.rds')
kh_to_df2 <- readRDS('kh_to_df2.rds')
cs_to_df2 <- readRDS('cs_to_df2.rds')
kg_to_df2 <- readRDS('kg_to_df2.rds')
```
...
During the first round of tweet collection, there was a "Hold Facebook Accountable" advocacy campaign taking place where several of the same tweet was sent to multiple senators. Because these tweets are exact copies, and because they are not adding to the data in terms of differences between how persons address male and female politicians, I am removing them from the dataset. I searched for other type of advocacy campaigns in the tweets but did not find any for the first round. I performed the same search in the second round, and 
...
write.csv(all_tweets_f, "all_f.csv") # Females
write.csv(all_tweets_m, "all_m.csv") # Males
saveRDS(all_tweets_f, "all_f.rds")  # Females
saveRDS(all_tweets_m, "all_m.rds") # Males
```
